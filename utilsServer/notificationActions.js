...
const newCommentNotification = async (userId, postId, userToNotifyId, commentId, text) => {
    try {
        const userToNotify = await NotificationModel.findOne({ user: userToNotifyId });
...
const removeCommentNotification = async (userId, postId, userToNotifyId, commentId) => {
    try {
        const user = await NotificationModel.findOne({ user: userToNotifyId });
